...
[![Windows build status](https://ci.appveyor.com/api/projects/status/github/marksendak/constellation?svg=true)](https://ci.appveyor.com/project/marksendak/constellation)
